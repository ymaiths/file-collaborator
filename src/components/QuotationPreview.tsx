...
export const QuotationPreview = ({ data, isEditMode, onUpdateItem, onUpdateTerms, onUpdateTotalOverride,onAddItem,onUpdateDiscount,onDeleteItem }: QuotationPreviewProps) => {
  ...
  return (
    // 🌟 1. ย้ายคลาสสีขาว/เงา/ขอบกระดาษ มาห่อด้านนอกสุดแบบ Responsive กว้าง 100%
    <div className="w-full max-w-full bg-white shadow-lg border border-gray-200 rounded-sm">
        
      {/* 🌟 2. สร้างกล่องสำหรับ Scroll ห่อตัวกระดาษข้างในอีกชั้น */}
      <div className="w-full overflow-x-auto custom-scrollbar p-[5mm] md:p-[10mm]">
          
          {/* 🌟 3. ให้กว้างเต็มจอ (w-full) ยืดหยุ่นได้ แต่ห้ามหดเล็กกว่าขนาดแท็บเล็ต (768px) */}
          <div className="w-full min-w-[600px] text-gray-800 font-sans box-border">        
            {/* Header Label */}
            ...
            <table className="w-full border-collapse mb-6">
              <thead>
                <tr>
                  ...
                  <th className={`${headerClass} w-[30%] min-w-[150px]`}>รายการ (Description)</th>
